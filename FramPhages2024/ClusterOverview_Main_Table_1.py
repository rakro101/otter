...
num_coefficients = 16
from FramPhages2024.config import name_dict, color_dict
...
if __name__ == "__main__":
    ...
    print(meta.columns)
    meta["cluster_names"] = meta["LouvainLabelD"]
    ...
    seasons = (
        ...
        .agg({"asv_count": "sum", "max_abundance_month": pd.Series.mode})
        .reset_index()
    )
    df_table_1 = pd.merge(
    ...
    print(df_table_1)
    df_table_1.to_csv("tables/ClusterOverview_Main_Table_1_CON_Overview.csv")
