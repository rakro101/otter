...
figure_path ="/Users/raphaelkronberg/PycharmProjects/ELLEN/CCMN_Paper_Submission/figures/woSeason_final_proj/"
table_path =  "/Users/raphaelkronberg/PycharmProjects/ELLEN/CCMN_Paper_Submission/tables/woSeason_final_proj/"

#cluster_no ="Test_09-H-Fig5_Project_Condtions__final_"
cluster_no ="Test_10-H-Fig5_Project_Condtions__final_"
...
#baseabtable = read.csv("CCMN_Paper/data/Raw_Ela_Cluster_09-H.csv", sep=';')
baseabtable = read.csv("/Users/raphaelkronberg/PycharmProjects/ELLEN/CCMN_Paper_Submission/data/Raw_Ela_Cluster_10HS.csv", sep=';')
...
max(basemetadata_arctic$O2_conc)
...
pruning_pars = c(0.02, 0.01, 0.99) # 0.001, #0.01, #0.005
